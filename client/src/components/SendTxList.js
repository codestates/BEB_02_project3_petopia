    ...
    return (
        <div className="txSendList">
            <Table bordered>
                <thead>
                    <tr>
                        <th class ="txDateTitle">Date</th>
                        <th class ="txToTitle">To</th>
                        <th class ="txAmountTitle">Amount</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        txList.map((tx, idx) => {
                            ...
                            return (
                                <tr key={idx}>
                                    ...
                                    <td>
                                        <button className = "scopeButton" onClick={()=>{window.open(`https://baobab.scope.klaytn.com/tx/${tx.transaction.transactionHash}?tabId=tokenTransfer`)}}>Klaytn Scope에서 보기 <FontAwesomeIcon icon={faArrowUpRightFromSquare} size="1.5x" /></button>
                                    </td>
                                </tr>
                            )
                        })
